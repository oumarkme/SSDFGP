...
# Fit growth curve model
#' @name RErs.det
#' @title Training set size determination
#' @description Training set size determination for genomic selection. Detail described in published article by Wu et al.
#' @import parallel
#' @import TSDFGS
#' @import dplyr
#' @import ggplot2
#' @import latex2exp
#' @param geno Genetic data performed by data.frame format
#' @param nt Vector of training set sizes for estimate logistic growth curve parameters. Auto generated by default = NULL.
#' @param n_iter Number of iterations for estimating parameters. Default times of iteration equals to the length of vector nt.
