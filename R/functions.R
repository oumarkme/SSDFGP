...
#' @import ggplot2
#' @import latex2exp
#' @param geno A numeric data frame carried genotype information (column: variants/PCs, row: sample)
...
#' @export
RErs.det = function(geno, nt = NULL, n_iter = NULL, multi.threads = TRUE){
